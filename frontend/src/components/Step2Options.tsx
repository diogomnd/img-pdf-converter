        ...
        <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
                ...
                <Toggle
                    ...
                    value={options.mode}
                    onChange={(v) =>
                        onChange({ mode: v as ConvertOptions["mode"] })
                    }
                />
            </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                <Toggle
                    ...
                    onChange={(v) =>
                        onChange({
                            page_size: v as ConvertOptions["page_size"],
                        })
                    }
                />
            </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                <Toggle
                    ...
                    onChange={(v) =>
                        onChange({
                            orientation: v as ConvertOptions["orientation"],
                        })
                    }
                />
            </div>
            ...
            <div className="flex flex-col gap-2">
                <label className="text-xs text-gray-400 uppercase tracking-wider">
                    Margem —{" "}
                    <span className="text-white">{options.margin_px}px</span>
                </label>
                <input
                    type="range"
                    min={0}
                    ...
                    onChange={(e) =>
                        onChange({ margin_px: Number(e.target.value) })
                    }
            ...
            <div className="flex flex-col gap-2">
                <label className="text-xs text-gray-400 uppercase tracking-wider">
                    Qualidade —{" "}
                    <span className="text-white">{options.quality} dpi</span>
                </label>
                <input
                    type="range"
                    min={72}
                ...
                <p className="text-xs text-gray-500">
                    Afeta resolução para tamanhos fixos (A4/Letter). Ignorado no
                    modo "ajustar à imagem".
                </p>
            </div>
